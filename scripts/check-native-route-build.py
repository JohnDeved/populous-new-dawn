...
else{const unexpected=()=>{throw Error('Unexpected planning consumer');};result=planPersonDestination({routes:w,skip:0,checkingPerson:0,levelFlags2:0,computerLimit:0,humanLimit:0,tribes:Array.from({length:4},()=>({playerType:1,requests:0})),land:{flags:new Uint32Array(16384),categories:new Uint8Array(16384),buildingIds:new Uint16Array(16384)},vehicles:new Map([[2,c.vehicle]])},p,c.to,
