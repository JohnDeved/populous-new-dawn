...
print('PASS: 6144 native state-1/8/10/14/17/19/26/36/39/41 initializers, flags, RNG, selection counts and camera-relative facing; world effects supplied')
