...
| Validation | Twenty regression tests, native CPU comparisons and real-browser mission/visual QA, including rendered pyramid identity and all three opening callouts | Original-engine traces, cross-engine replay comparisons, complete campaign and multiplayer scenarios |
