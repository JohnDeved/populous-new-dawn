...
| Validation | Eighteen regression tests, native CPU comparisons and real-browser mission/visual QA | Original-engine traces, cross-engine replay comparisons, complete campaign and multiplayer scenarios |
