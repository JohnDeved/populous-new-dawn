...
| Economy and buildings | Native mana, breeding/training bands and hut upgrade values; original rotated entrance/queue footprint geometry CPU-compared and door routing integrated; native occupant admission/removal, containing-building lookup, visibility/order cleanup and training repricing CPU-compared | Construction, repair/fire/damage, activity timers and all building classes |
