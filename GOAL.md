...
| World, terrain, camera | Original mission-one data, textures and models; native tile split/height routines CPU-compared and used during import; opening flyby queue, motion profiles and 4,077 timeline frames CPU-compared | Exact toroidal coordinates, deformation, projection, visibility and camera behavior |
| Graphics and interface | Original layered unit sprites, native bank-2 meshes, HUD and several effects; bank redirect and vault morph coordinates CPU-compared | All animation states, layers, palettes, blend passes, effects and controls; full morph scheduler and hut variant RNG |
