...
**Next action:** match the original HUD layout, fonts, icons and labels, then
selection, camera and command feedback. Native water texture and wave-point
calculations are now CPU-compared and integrated; the rendered map covers all
128×128 native cells, fixing the cropped southern shoreline. Native coastal
