...
- **partial** — Whole-frame visibility, ordering and raster fidelity (`graphics.raster`). Non-drawing texture-mode-0 faces now omitted from raster meshes. Remaining filtering, clipping, painter order, native picking ownership and matched original-frame comparisons are open. Evidence: [references/visual-audit.md](references/visual-audit.md), [decomp/generated/004673b0.c](decomp/generated/004673b0.c), [scripts/check-browser-scenery-fire.mjs](scripts/check-browser-scenery-fire.mjs), [scripts/check-browser-building-fire.mjs](scripts/check-browser-building-fire.mjs).
