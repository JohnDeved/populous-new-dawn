...
- **partial** — Complete camera movement and visibility behavior (`world.camera`). Native focus journeys preserve heading/zoom; native keyboard and drag movement now drive desktop controls with integer directions, speed and wrapping. Mixed native input/momentum comparisons and actual browser keyboard, drag, pause/lock, frame timing and takeover checks pass. Input uses a 24 Hz momentum-off adapter; full settings, input sampling/bindings, edge scrolling, frame scheduling, minimap mapping, overview transitions and visibility remain incomplete. Evidence: [scripts/check-native-camera-motion.py](scripts/check-native-camera-motion.py), [scripts/check-native-projection.py](scripts/check-native-projection.py), [app/camera-motion.ts](app/camera-motion.ts), [scripts/check-browser-camera-focus.mjs](scripts/check-browser-camera-focus.mjs), [qa/flyby-check.mjs](qa/flyby-check.mjs), [app/camera-input.ts](app/camera-input.ts), [scripts/check-native-camera-input.py](scripts/check-native-camera-input.py), [scripts/check-browser-camera-input.mjs](scripts/check-browser-camera-input.mjs).
...
- **partial** — Dynamic lighting and shadows (`graphics.lighting`). Terrain diffuse/additive conversion, scenery shade, standing/airborne sprite shadows, model sunlight/depth fading and hovered-model gray/white overrides are compared and integrated. Dynamic sunlight propagation, other colored effects, debris lighting and full lifecycle/renderer ownership remain incomplete. Evidence: [scripts/check-native-vertex-lighting.py](scripts/check-native-vertex-lighting.py), [scripts/check-browser-water.mjs](scripts/check-browser-water.mjs), [scripts/check-native-scenery-shadow.py](scripts/check-native-scenery-shadow.py), [scripts/check-browser-scenery-fire.mjs](scripts/check-browser-scenery-fire.mjs), [tests/game.test.mjs](tests/game.test.mjs), [scripts/check-native-unit-shadows.py](scripts/check-native-unit-shadows.py), [scripts/check-browser-unit-shadows.mjs](scripts/check-browser-unit-shadows.mjs), [scripts/check-native-model-lighting.py](scripts/check-native-model-lighting.py), [scripts/check-browser-model-lighting.mjs](scripts/check-browser-model-lighting.mjs), [scripts/check-native-model-highlight.py](scripts/check-native-model-highlight.py), [scripts/check-browser-model-highlight.mjs](scripts/check-browser-model-highlight.mjs).
- **partial** — Whole-frame visibility, ordering and raster fidelity (`graphics.raster`). Non-drawing texture-mode-0 faces are omitted. Native texture initialization/state selection is CPU-checked; ordinary model/cloud/terrain/water materials now filter encoded palette colors bilinearly without mipmaps or anisotropy. 80 GPU calibration samples and unchanged unit point sampling are checked. Full graphics settings, per-batch sampler ownership, texture formats/UV padding, clipping, painter order, native picking and matched original frames remain open. Evidence: [references/visual-audit.md](references/visual-audit.md), [decomp/generated/004673b0.c](decomp/generated/004673b0.c), [scripts/check-browser-scenery-fire.mjs](scripts/check-browser-scenery-fire.mjs), [scripts/check-browser-building-fire.mjs](scripts/check-browser-building-fire.mjs), [app/render-view.ts](app/render-view.ts), [scripts/check-native-texture-filter.py](scripts/check-native-texture-filter.py), [scripts/check-browser-texture-filter.mjs](scripts/check-browser-texture-filter.mjs), [decomp/generated/0047cc60.c](decomp/generated/0047cc60.c), [decomp/generated/0047d6f0.c](decomp/generated/0047d6f0.c).
