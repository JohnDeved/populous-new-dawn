...
| `0048cc60`, `0048f350`, `0041ca10`, `0041cc20`, `004a5d20`, `004a5d40`, `004a5ec0` | `app/model.ts`, `scripts/import-script.py` | First-mission initialization, bounded [Mission 3 recurring flyby](research/mission3-recurring.md), [Mission 4 objective](research/mission4.md), [Mission 7 opening](research/mission7.md), and [Mission 10 first Totem/flyby/deadline](research/mission10-opening.md) are applied; full game-command host and later Mission 10 objectives remain open |
