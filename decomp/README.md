...
| `004615f0`, `004e5530`, `004e5580`, `004c6da0` | `app/computer-runtime.ts` | [Mission 11's first settlement action](research/mission11-first-settlement.md) and [first Matak Hut](research/mission11-first-expansion.md) reuse the ordinary producer and construction task path; later exact `BUILD_AT`, Chumara housing, production profiles and attacks remain open |
