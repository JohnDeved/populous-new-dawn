...
| `0048cc60`, `0048f350`, `0041ca10`, `0041cc20` | `app/model.ts`, `scripts/import-script.py` | First-mission initialization, the bounded [Mission 3 recurring flyby](research/mission3-recurring.md), and [Mission 4 objective](research/mission4.md) are applied; full game-command host remains open |
