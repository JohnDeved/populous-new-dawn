...
| `004615f0`, `004e5530`, `004e5580`, `004c6da0` | `app/computer-runtime.ts`, `app/campaign-command-runtime.ts` | [Mission 11's first settlement action](research/mission11-first-settlement.md), [first Matak Hut](research/mission11-first-expansion.md), and [first scripted BUILD_AT tower](research/mission11-exact-tower.md) reuse the ordinary producer, spiral search, and construction task path; later `BUILD_AT`, staffing, Chumara housing, production profiles and attacks remain open |
