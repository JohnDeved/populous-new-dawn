...
| `0048cc60`, `0048f350`, `0041ca10`, `0041cc20` | `app/model.ts`, `scripts/import-script.py` | First-mission initialization, bounded [Mission 3 recurring flyby](research/mission3-recurring.md), [Mission 4 objective](research/mission4.md), and [Mission 7 opening](research/mission7.md) are applied; full game-command host remains open |
...
| `00463370`, `00463780`, `00463e80`, `004657d0`, `004659d0`, `00466be0` | `app/live-vehicles.ts`, `app/live-pathfinding.ts`, `app/scene-entities.ts` | [Mission 5 granted Boat](research/mission5-boat.md) is live through worship, boarding, sailing, landing and checkpoints; source artwork, construction, combat, bobbing and lifetime remain open |
