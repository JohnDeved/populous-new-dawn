...
No gift supplies the first boarding/travel/disembarkation sequence. That sequence must use one of the two already-authored class-4 vehicles through ordinary boarding; first boarding claims its ownership. Which vehicle is naturally reachable first through Mission 22 terrain/input was not exercised here and must be verified live rather than inferred from the reward tags.
...
- The browser now binds trigger 141 as a resource-neutral one-shot, both mana heads to the delayed lifecycle, and vehicles to ordinary boarding ownership. The independent 1,000,000-mana route, Balloon path, exact stone presentation, AI, and outcome remain open.
