/* Ghidra 12.1.3 pseudocode; entry 00438ca0; FUN_00438ca0.
 * See ../README.md and ../exports.json. Types/names may be inferred. Not compilable original source. */


/* WARNING: Removing unreachable block (ram,0x00438d0a) */
/* WARNING: Removing unreachable block (ram,0x00438d14) */

undefined1 FUN_00438ca0(int param_1,int param_2)

{
  ...
  if ((*(ushort *)(param_1 + 0x76) & 0x10) != 0) {
    *(ushort *)(param_1 + 0x76) = *(ushort *)(param_1 + 0x76) & 0xffef;
    FUN_004b9fc0(unit_land_array[*(ushort *)(param_1 + 0x89)],&local_4);
