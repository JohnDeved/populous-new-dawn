/* Ghidra 12.1.3 pseudocode; entry 004b52a0; d3d_destroy_res_2.
...
undefined4 d3d_destroy_res_2(void)

{
  ...
  if (landscape_surface_page_locked != 0) {
    if (minimap_surface == (LPDIRECTDRAWSURFACE4)0x0) goto LAB_004b5475;
