/* Ghidra 12.1.3 pseudocode; entry 0047dc50; add_polygon_quad_sprite_5a_4.
 * See ../README.md and ../exports.json. Types/names may be inferred. Not compilable original source. */


void __thiscall
add_polygon_quad_sprite_5a_4
...

{
  ...
  if ((param_2 < (float)*(int *)(param_1 + 0x248052)) &&
    ...
    if (((float)*(int *)(param_1 + 0x24804a) <= (float)*puVar4 + param_2) &&
      ...
      uVar2 = *(uint *)(*(int *)(param_1 + 0x20002a) + 0x4e);
      *(uint *)(*(int *)(param_1 + 0x20002a) + 0x4e) = (param_6 ^ uVar2) & 0xffffff ^ uVar2;
