/* Ghidra 12.1.3 pseudocode; entry 0050c380; FUN_0050c380.
 * See ../README.md and ../exports.json. Types/names may be inferred. Not compilable original source. */


void FUN_0050c380(int param_1)

{
  ...
  *(ushort *)(param_1 + 0x37) = (*(byte *)(param_1 + 0x2e) & 3) << 2;
  unit_set_object(param_1 + 0x33,1,0x142);
  uVar1 = *(uint *)(param_1 + 0xc);
  *(undefined2 *)(param_1 + 0x6c) = 4;
  *(uint *)(param_1 + 0xc) = uVar1 | 0x40000;
  *(uint *)(param_1 + 0xc) = uVar1 | 0x40080;
  *(uint *)(param_1 + 0xc) = uVar1 & 0xefffffff | 0x40080;
  return;
}
