/* Ghidra 12.1.3 pseudocode; entry 0041e3d0; FUN_0041e3d0.
 * See ../README.md and ../exports.json. Types/names may be inferred. Not compilable original source. */


void FUN_0041e3d0(int param_1)

{
  ...
  if ((unit_type_array_scenery[*(byte *)(param_1 + 0x2b)].flags_1 & 4) != 0) {
    ...
    (local_8->field0).next = polygons_to_draw[2];
    polygons_to_draw[2] = &local_8->field0;
    uVar1 = __ftol();
